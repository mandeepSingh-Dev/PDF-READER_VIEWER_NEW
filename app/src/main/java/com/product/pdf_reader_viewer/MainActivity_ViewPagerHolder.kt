 package com.product.pdf_reader_viewer
...
import com.product.pdf_reader_viewer.UtilClasses.ViewAnimation
import com.product.pdf_reader_viewer.ViewPagerAdapter.MyFragmentStateAdapter
      ...
      /*   var intent = Intent(Settings.ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION)
                 ...
                 when(it.itemId){
                    ...
                    R.id.settingMenuitem -> {
                         startActivity(Intent(this,
                             com.product.pdf_reader_viewer.SettingsActviity::class.java))
         ...
         binding?.fab2ImagetoPdf?.setOnClickListener {
             var intent=Intent(applicationContext,
                 com.product.pdf_reader_viewer.PdfsTools_Activity::class.java)
